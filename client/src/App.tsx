    ...
    <div className="p-4 pl-10 pr-10">
      <Card className="bg-blue-400 text-white max-w-[500px]">
        <CardHeader>
          ...
          <CardDescription className="text-xl text-white">по направлению к медицинским специалистам</CardDescription>
        </CardHeader>
      </Card>

      <h2 className="mt-9 text-xl font-medium">Введите ваши данные:</h2>
        ...
        <div>
          ...
          <RadioGroup value={gender ?? ""} onValueChange={setGender}>
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="man" className="text-base">мужчина</Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="women" id="women" />
              <Label htmlFor="women" className="text-base">женщина</Label>
            </div>
          </RadioGroup>
        </div>
      ...
      {!confirmed ? (
        <Button
          variant="outline"
          className="mt-7 bg-blue-400 text-white"
        ...
        <Button variant="outline" className="mt-7 bg-blue-400 text-white" onClick={handleReset}>
          Сбросить
        </Button>
      )}
